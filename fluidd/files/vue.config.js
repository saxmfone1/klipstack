  ...
  chainWebpack: config => {
    ...
    config
      ...
      .tap(args => {
        ...
        args[0]['process.env'].HASH = JSON.stringify('')
        return args
      })
  }
}
